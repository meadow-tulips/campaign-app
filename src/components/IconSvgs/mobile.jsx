...
const MobileSVG = (props) => {
    ...
    <svg version="1.1" id="Capa_1" x="0px" y="0px"
         viewBox="0 0 512 512" enableBackground="0 0 512 512" {...props}>
    <g>
        <g>
            <path stroke="red" d="M366,0H146c-20.678,0-37.5,16.822-37.5,37.5v437c0,20.678,16.822,37.5,37.5,37.5h220c20.678,0,37.5-16.822,37.5-37.5v-437
